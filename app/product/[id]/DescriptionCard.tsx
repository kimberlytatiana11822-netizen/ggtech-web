...
export default function DescriptionCard({ description }: { description?: string | null }) {
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-sky-500/10 via-sky-400/5 to-transparent border border-sky-500/40 shadow-[0_0_30px_-8px_rgba(56,189,248,0.4)] p-6 overflow-hidden">
