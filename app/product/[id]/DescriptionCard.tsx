export default function DescriptionCard({ description }: { description?: string | null }) {
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-orange-500/10 via-amber-500/5 to-transparent border border-orange-500/20 p-6 overflow-hidden">
